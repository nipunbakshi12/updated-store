        ...
        <div className='border-t pt-14'>
            ...
            <div>
                {cartData.map((item, index) => {
                    ...
                    return (
                        <div key={index} className='py-4 border-b border-t border-gray-700 grid grd-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                            ...
                            <img src={assets.bin_icon} className='w-4 mr-4 sm:w-5 cursor-pointer' onClick={() => updateQuantity(item._id, item.size, 0)} />
                        </div>
                    )
                })}
            </div>
